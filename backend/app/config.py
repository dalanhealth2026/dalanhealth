...
class Settings(BaseSettings):
    ...
    # PostgreSQL (Neon) in production; SQLite locally so dev needs no server.
    # Accepts postgres:// / postgresql:// — normalized to asyncpg automatically.
    database_url: str = "sqlite+aiosqlite:///./dalanhealth.db"
