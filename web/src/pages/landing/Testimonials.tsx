...
const QUOTES: Quote[] = [
  ...
  { quote: '₹9 per patient and nothing else. No yearly contract pressure, no surprise renewal call. I pay exactly for what I use.', name: 'Dr. V. Thakur', role: 'Orthopaedic Clinic, Bhagalpur', metric: '₹0 fixed cost' },
